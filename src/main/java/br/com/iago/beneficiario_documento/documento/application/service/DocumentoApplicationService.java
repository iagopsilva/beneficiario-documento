...
public class DocumentoApplicationService implements DocumentoService {
    ...
    @Override
    public List<DocumentoBeneficiarioListResponse> buscaDocumentosDoBeneficiario(UUID idBeneficiario) {
        log.info("[inicia] DocumentoApplicationService - criaDocumento");
        beneficiarioService.buscaBeneficiarioAtravesId(idBeneficiario);
    ...
    public DocumentoBeneficiarioDetalhadoResponse buscaDocumentoDoBeneficiario(UUID idBeneficiario, UUID idDocumento) {
        ...
        return new DocumentoBeneficiarioDetalhadoResponse(documento);
    }

    @Override
    public void deletaDocumentoDoBeneficiario(UUID idBeneficiario, UUID idDocumento) {
